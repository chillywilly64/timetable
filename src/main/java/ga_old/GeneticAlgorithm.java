...
public class GeneticAlgorithm {	
	...
	private static List<String>weekDayNames=new ArrayList<>();
	private static List<String>lectureTimings=new ArrayList<>();
	
	public static void populationAccepter(List<TimeTable> timeTableCollection) throws IOException{
	...
	public static void selection(List<TimeTable> timetables) throws IOException{
		int iterations=50;
		int i=1;
